...
public abstract class MicroService implements Runnable {
    ...
    private final static MessageBusImpl msgBus = MessageBusImpl.getInstance();
    private final Map< Class<? extends Message>, Callback<? extends Message> > callbacks;
    ...
    protected final <T> Future<T> sendEvent(Event<T> e) {
        System.out.println(getName() + " Sends " + e.getClass().getSimpleName()) ; //<----------for test----------->
    ...
    protected final void sendBroadcast(Broadcast b) {
        System.out.println(getName() + " Sends " + b.getClass().getSimpleName()) ; //<----------for test----------->
    ...
    public final void run() {
        ...
        try{
            while (!terminated) {
                ...
                System.out.println(getName() + " recived " + msg.getClass().getSimpleName()); //<----------for test----------->
